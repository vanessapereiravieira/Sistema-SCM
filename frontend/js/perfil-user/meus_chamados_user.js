...
if (USUARIO_ROLE !== 'user') {
    window.location.href = '../../pages/perfil-admin/meus_chamados_admin.html';
}
...
let contadorExcluidos = localStorage.getItem('contadorExcluidos');
...
let chamadosExcluidos = localStorage.getItem('chamadosExcluidos');
    ...
    try {
        ...
        if (resposta.ok) {
            ...
            if (chamadoRemovido !== null) {
                ...
                localStorage.setItem('contadorExcluidos', contadorExcluidos);
